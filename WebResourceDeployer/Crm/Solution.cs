...
namespace WebResourceDeployer.Crm
{
    public static class Solution
    {
        ...
        public static EntityCollection RetrieveSolutionsFromCrm(CrmConnect client, bool getManaged)
        {
            try
            {
        ...
        public static bool AddWebResourceToSolution(CrmConnect client, string uniqueName, Guid webResourceId)
        {
            try
            {
