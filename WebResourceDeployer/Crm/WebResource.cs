...
namespace WebResourceDeployer.Crm
{
    public static class WebResource
    {
        ...
        public static EntityCollection RetrieveWebResourcesFromCrm(CrmConnect client)
        {
            ...
            try
            {
                ...
                while (moreRecords)
                {
                    ...
                    var partialResults = client.Service.RetrieveMultiple(query);
        ...
        public static Entity RetrieveWebResourceFromCrm(CrmConnect client, Guid webResourceId)
        {
            try
            {
                var webResource = client.Service.Retrieve("webresource", webResourceId,
        ...
        public static Entity RetrieveWebResourceContentFromCrm(CrmConnect client, Guid webResourceId)
        {
            try
            {
                var webResource = client.Service.Retrieve("webresource", webResourceId, new ColumnSet("content", "name"));
        ...
        public static string RetrieveWebResourceDescriptionFromCrm(CrmConnect client, Guid webResourceId)
        {
            try
            {
                var webResource = client.Service.Retrieve("webresource", webResourceId, new ColumnSet("description"));
        ...
        public static void DeleteWebResourceFromCrm(CrmConnect client, Guid webResourceId)
        {
            try
            {
                client.Service.Delete("webresource", webResourceId);
        ...
        public static Guid CreateWebResourceInCrm(CrmConnect client, Entity webResource)
        {
            try
            {
                var id = client.Service.Create(webResource);
        ...
        public static bool UpdateAndPublishSingle(CrmConnect client, List<Entity> webResources)
        {
            //CRM 2011 < UR12
            try
            {
                ...
                client.Service.Execute(publishRequest);
        ...
        public static bool UpdateAndPublishMultiple(CrmConnect client, List<Entity> webResources)
        {
            //CRM 2011 UR12+
            try
            {
                ...
                var wasError = false;
                var emResponse = (ExecuteMultipleResponse)client.Service.Execute(emRequest);
