...
namespace PluginTraceViewer.Crm
{
    public static class PluginTrace
    {
        ...
        public static EntityCollection RetrievePluginTracesFromCrm(CrmConnect client, DateTime afterDate)
        {
            ...
            try
            {
                ...
                EntityCollection traceLogs = client.Service.RetrieveMultiple(query);
        ...
        public static List<Guid> DeletePluginTracesFromCrm(CrmConnect client, Guid[] pluginTraceLogIds)
        {
            ...
            try
            {
                ...
                ExecuteMultipleResponse executeMultipleResponse =
                    (ExecuteMultipleResponse)client.Service.Execute(executeMultipleRequest);
